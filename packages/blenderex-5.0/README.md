...
It adds the following commands: `blender5.0`.
...
```sh
uvx --from blenderex-5.0 blender5.0
```

Or add the package as a dependency and run it from Python:

```sh
uv add blenderex-5.0
```

```python
from blenderex_5_0 import blender5.0
