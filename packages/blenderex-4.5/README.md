...
It adds the following commands: `blender4.5`.
...
```sh
uvx --from blenderex-4.5 blender4.5
```

Or add the package as a dependency and run it from Python:

```sh
uv add blenderex-4.5
```

```python
from blenderex_4_5 import blender4.5
